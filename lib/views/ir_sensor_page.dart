...
class IrSensorPage extends StatefulWidget {
  const IrSensorPage({Key? key}) : super(key: key);

  @override
  _IrSensorPageState createState() => _IrSensorPageState();
}

class _IrSensorPageState extends State<IrSensorPage> {
